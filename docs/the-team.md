...
Agents were orchestrated through an agent framework that runs named AI agents with separate contexts, persistent identities, and tool access. Each agent had:
